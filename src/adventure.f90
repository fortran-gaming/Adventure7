...
!  YEA IS RANDOM YES/NO REPLY
      ...
      INTEGER TRVS,TRVSIZ,VEND,VERB,VRBSIZ,WASTE,UNLOCK,RANZ,LIQ,CONFUZ,NOWAY,VAL,CLASS,BURDEN,LIQLOC,VOCABX,&
...
!     ****** GET DATABASE FROM DISK
      ...
      READ(U)  ISWIZ,ADJKEY,ADJTAB,ADJSIZ,BLKLIN,LOCCON,OBJCON,NUMDIE,MAXDIE,TURNS,KILLED,DWARF,KNIFE,KNFLOC,DFLAG,DSEEN,DLOC,&
                ...
                VERB,VRBSIZ,WASTE,WASDARK,YEA,ACTSPK,CTEXT,CVAL,HNAME,ANVIL,BASILISK,BATTER,BEES,BILLBD,BIRD,BRUSH,&
...
13000  OPEN(newunit=U,FILE=FILNAM,STATUS='UNKNOWN',FORM='UNFORMATTED',ACCESS='SEQUENTIAL',iostat=I)
       WRITE(U,IOSTAT=I) &
                   ...
                   WASDARK,YEA,ACTSPK,CTEXT,CVAL,HNAME
         CLOSE(U,STATUS='KEEP')
         IF (I/=0)  THEN
